...
public class FirstNameUtility {
    private final Map<String, Integer> firstNameCodeMap;
    private final Map<String, Integer> firstInitialCodeMap;
    private final Map<String, Integer> middleInitialCodeMap;

    public FirstNameUtility() {
        this.firstNameCodeMap = new HashMap<>();
        this.firstInitialCodeMap = new HashMap<>();
        this.middleInitialCodeMap = new HashMap<>();
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException {
        if (Objects.equals(firstName, "")) {
            ...
            if (firstNameCodeMap.containsKey(firstName)) {
                if (!Objects.equals(middleInitial, "")) {
                ...
                int z = firstInitialCodeMap.get(firstLetter);
                if (!Objects.equals(middleInitial, "")) {
                    int zz = firstInitialCodeMap.get(firstLetter);
                    String mi = middleInitial.toUpperCase();
                    int x = middleInitialCodeMap.get(mi);
                    int b = x + z;
                    return z + x;
                } else {
                    return firstNameCodeMap.get(firstLetter);
                }
            }
        }
    }
